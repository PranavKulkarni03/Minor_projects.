...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to ambitious</h1>
        <small class="my-content">Learn and Implement</small><br />
        <small class="my-content">Learning keeps you in the lead. Get the latest skills now.</small><br />
        <?php    
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>ambitious provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>ambitious pvt Ltd <br> Near sawarkar chowk <br> Aurangabad,Maharashtra <br> Ph. 9392140140 </p>
          </div>
        </div>
      </div>
